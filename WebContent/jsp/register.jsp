	...
	$(function() {
		...
		$("#codeImg").click(
				function() {
					$(this).prop(
							"src",
							"${pageContext.request.contextPath}/code?"
									+ Math.random());
				})
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" id="formId" style="margin-top: 5px;"
					method="post"
					action="${pageContext.request.contextPath }/user?act=regist">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								name="sex" value="男" id="inlineRadio1" value="option1"
								checked="checked"> 男
							</label> <label class="radio-inline"> <input type="radio"
								name="sex" value="女" id="inlineRadio2" value="option2">
								女
							</label> <label for="sex" class="error"></label>
						</div>
					</div>
					<div class="form-group">
